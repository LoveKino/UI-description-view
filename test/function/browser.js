...
let testFiles = {
    ...
    'search:content:textLength': path.join(__dirname, '../browser/case/search/content/textLength.js'),
    'search:style:backgroundColor': path.join(__dirname, '../browser/case/search/style/backgroundColor.js')
};
